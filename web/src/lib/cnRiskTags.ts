...
export const CN_RISK_TAGS: CnRiskTagMeta[] = [
  ...
  { risk_tag: "培训材料违规", description: "销售培训材料存在误导或违规内容", category: "营销活动", competition_id: "R003" },
  { risk_tag: "回访违规", description: "客户回访过程中存在误导或信息不实", category: "售后违规", competition_id: "R001" },
  { risk_tag: "电销违规", description: "电话销售过程中存在违规行为", category: "销售渠道", competition_id: "R001" },
  { risk_tag: "不当比较", description: "不当将本公司产品与其他公司产品进行比较", category: "营销违规", competition_id: "R003" },
  { risk_tag: "贬低竞品", description: "贬低或诋毁其他保险公司产品", category: "营销违规", competition_id: "R003" },
  { risk_tag: "绝对化表述", description: "使用最高级、绝对化或无法证实的表述", category: "营销违规", competition_id: "R001" },
  ...
  { risk_tag: "虚构收益率", description: "虚构或编造不存在的收益率数据", category: "销售误导", competition_id: "R001" },
  { risk_tag: "诱导投保", description: "使用不当手段诱导消费者投保", category: "营销违规", competition_id: "R002" },
  { risk_tag: "避债避税", description: "宣传保险具有规避债务或税收的功能", category: "营销违规", competition_id: "R001" },
  ...
  // 无官方 R00x：产品合规 / 业务数据不实，勿挂靠 R006（编制虚假财务资料）
  { risk_tag: "未按规定使用费率条款", description: "未按监管备案的费率和条款执行", category: "合规问题" },
  { risk_tag: "客户信息不真实", description: "客户信息记录虚假或不真实", category: "合规问题" },
  { risk_tag: "其他", description: "其他类型的违规行为", category: "其他" },
];
